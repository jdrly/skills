...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, driving `/tdd` at pre-agreed seams, then reviewing a committed range from a pinned base.
...
- **[prototype](./prototype/SKILL.md)** — Build a throwaway prototype to answer a design question: a shareable HTML demo for state/logic, or several toggleable UI variations.
