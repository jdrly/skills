...
On the `codex` branch, read [`.agents/codex-port.md`](./.agents/codex-port.md)
before changing any skill. It defines the boundary between upstream-owned
behavior and this branch's Codex harness adaptations.
